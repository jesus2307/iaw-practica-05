...
IP_PRIVADA=172.31.84.134

#Es para conectar al phpmyadmin. genera una contraseña aleatoria a partir de /dev/urandom (integrado en linux para hacer contraseñas random) y los comandos dicen que de la A-Z mayuscula y minúscula del 0 al 9. para config.inc.php
